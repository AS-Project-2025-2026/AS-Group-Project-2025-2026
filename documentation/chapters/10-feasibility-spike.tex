...
conflict handling, and dead-letter intervention can remain documented target behaviour if
implementation time is limited, because the spike has confirmed that the seams for all of them
