...
publishes a \texttt{pos.stock.reported} message with a quantity diverging from the WMS value
...
\hline
Normal flow & \path{screenshots/05-normal-flow.png} &
...
\hline
Warehouse failure & \path{screenshots/07-warehouse-failure-cb-open.png} &
